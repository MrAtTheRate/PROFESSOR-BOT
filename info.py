...
# PyroClient Setup 
API_ID = int(environ['API_ID', '27382550'])
API_HASH = environ['API_HASH', 'c428034cb811de290315501d8e3c82b5']
BOT_TOKEN = environ['BOT_TOKEN','7726811222:AAE5-CC1q1XcFvHENLTazx7XovD6ULKFqhM']
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002350475152 -1002013490678').split()]
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Professor:Professor123@cluster0.xlmetem.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
